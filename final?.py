...
bottomTread       = Motor(Ports.PORT6, GearSetting.RATIO_18_1, True)
topTread          = Motor(Ports.PORT8, GearSetting.RATIO_18_1, True)
optical2x2        = Optical(Ports.PORT4)
wheel2x2          = Motor(Ports.PORT3, GearSetting.RATIO_18_1, True)
optical3x2        = Optical(Ports.PORT5)
wheel3x2          = Motor(Ports.PORT2, GearSetting.RATIO_18_1, True)
catchError2x2Red  = Optical(Ports.PORT1)
catchError2x2Blue = Optical(Ports.PORT7)
catchError3x2Red  = Optical(Ports.PORT9)
...
def whenStarted():
    ...
    while True:
        if isDebounced():
            ...
            optical2x2.set_light_power(25, PERCENT)
            optical3x2.set_light_power(25, PERCENT)
